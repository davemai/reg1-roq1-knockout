...
samples_all <- list.files(path = "PATH/Baseline bulk RNAseq/Salmon/Combined_all", full.names = T, pattern = "quant$")
files_all <- file.path(samples_all, "quant.sf")
names(files_all) <- str_replace(samples_all, "PATH/Baseline bulk RNAseq/Salmon/Combined_M5", "") %>% 
  str_replace(".salmon", "")
...
gtf.file = "PATH/Baseline bulk RNAseq/Salmon/ND539_M5/Homo_sapiens.GRCh38.CARM5.gtf"
