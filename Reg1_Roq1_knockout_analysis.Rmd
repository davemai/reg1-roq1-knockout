...
samples_all <- list.files(path = "C:/Users/damai/Desktop/Research/Projects/1 - Reg1 & Roq1/functional/Baseline bulk RNAseq/Salmon/Combined_all", full.names = T, pattern = "quant$")
files_all <- file.path(samples_all, "quant.sf")
names(files_all) <- str_replace(samples_all, "C:/Users/damai/Desktop/Research/Projects/1 - Reg1 & Roq1/functional/Baseline bulk RNAseq/Salmon/Combined_M5", "") %>% 
  str_replace(".salmon", "")
...
gtf.file = "C:/Users/damai/Desktop/Research/Projects/1 - Reg1 & Roq1/functional/Baseline bulk RNAseq/Salmon/ND539_M5/Homo_sapiens.GRCh38.CARM5.gtf"
...
gsea_reg1 <- read_csv("C:/Users/damai/Documents/bulk-rnaseq/reg1_results.csv")
...
pathways.hallmark <- gmtPathways("C:/Users/damai/Documents/bulk-rnaseq/h.all.v7.5.1.symbols.gmt")
...
gsea_roq1 <- read_csv("C:/Users/damai/Documents/bulk-rnaseq/roq1_results.csv")
...
gsea_dko <- read_csv("C:/Users/damai/Documents/bulk-rnaseq/dko_results.csv")
